...
module Todo
  ...
  class Todo_Calculation_Entry_Controller < Todo_Entry_Controller
    ...
    def add
      form = model_form(:model => Todo_Calculation_Entry, :action => :perform_add)
    ...
    def update
      ...
      form     = instance_form(:model => Todo_Calculation_Entry, :action => :perform_update)
    ...
    def after_change
      ...
      redirect_to(:controller => 'Todo::Todo_Calculation_Asset', 
                  :action => :show, 
